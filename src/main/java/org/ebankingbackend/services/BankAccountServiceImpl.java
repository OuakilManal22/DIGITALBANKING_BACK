...
public class BankAccountServiceImpl implements BankAccountService {
    ...
    public List<BankAccountDTO> searchAccounts(String keyword) {
        List<BankAccount> accounts=bankAccountRepository.searchAccount(keyword);
        List<BankAccountDTO> customerDTOS = accounts.stream()
                .map(cust -> dtoMapper.fromCurrentBankAccount((CurrentAccount) cust))
                .collect(Collectors.toList());
        return customerDTOS;
    }
}
